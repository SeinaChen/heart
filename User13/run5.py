...
import pandas as pd
#Document_ls = ['step']
Document_ls = ['heart5','sleep5','step5']
...
def processing(df,date,a,b):
  ...
  day_time = [(i[1],i[2]) for i in new if i[0] == "2018-05-"+ date]
...
for i in range(31):
  for t in range(96):
     string = "2018-05-"+str(i+1)+" "+str(0.25*t)+"時"
...
data.to_csv("/Users/xinnanchen/Desktop/datascience/result_ID13/result5.csv")
